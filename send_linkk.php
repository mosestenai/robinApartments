...
//link to the reset password page and token
 $url = "https://robin.herokuapp.com/create-new-password.php?selector=" . $selector ."&validator=" . bin2hex($token);
...
$email->setFrom("eazistey@gmail.com","Robin.com");
$email->setSubject("Reset your password");
$email->addTo($userEmail,$userEmail);
$email->addContent("text/plain", "Robin comfort reset password email");
$email->addContent(
